      ...
      <div className={navBarContainerClassName}>
        <div className={centerNavBarClassName}>
          <div className="navLogoContainer">
            <NavLink to="/" className="takeADayTripText">
              Take A Daytrip
            </NavLink>
          </div>
          <div className="placesToStayTextContainer">
            {" "}
            <div
              className="placesToStayButtonContainer"
          ...
          <div className="profileButtonContainer">
            ...
            >
              ...
              >
                ...
                {session?.profile_image === null || session === null ? (
