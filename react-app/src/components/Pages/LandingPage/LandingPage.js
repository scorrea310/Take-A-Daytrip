    ...
    <div className="landingPage">
      ...
      <div className="landingPageBigImageContainer">
        <div className="landingPageBigImageAndButtonContainer">
          ...
          <Button
            type={"Button"}
            className={"imFlexibleButton"}
            label={"I'm flexible"}
            onClick={() => history.push("/allspots")}
          />
        </div>
      </div>
      <div className="landingPageCategorySection">
        <div className="categorySectionContainer">
          <div className="inspritationForYourText">
          ...
          <div className="landingPageCardSection">
            ...
            <CategoryCard
              thirdCard={true}
              picture={"apartment"}
              historyUrl={"/apartments"}
            />
            <CategoryCard
              rightCard={true}
              picture={"unique experience"}
              historyUrl={"/unique"}
            />
          </div>
        </div>
        ...
        <div className="tryHostingCard">
          <div className="tryHostingContentCardMain">
            ...
            <div
              ...
              className="createListingButtonLandingPage"
            >
              Create Listing
            </div>
          </div>
        ...
        <div className="uniqueAndOutdoorCardContainer">
          <div className="bigOutdoorCard">
            <div className="thingsToDoOutsideContainer">
              ...
              <div
                onClick={() => history.push("/outdoors")}
                className="outdoorExperiencesButton"
              >
                Outdoor Experiences
              </div>
            </div>
          ...
          <div className="bigUniqueCard">
            <div className="uniqueThingsToDo">
              ...
              <div
                ...
                className="uniqueExperencesButtonBigCard"
              >
                Unique Experiences
              </div>
            </div>
