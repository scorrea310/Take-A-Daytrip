...
const EditSpot = ({ spot, spotId }) => {
  ...
  const [price, setPrice] = useState(
    parseFloat(spot[`${spotId}`].price_per_day)
  );
  ...
  return (
    <div className="editSpotContainer">
      ...
      <div className="editOrDeleteSpotContainer">
        <div className="editIconAndText" onClick={() => setShowEditModal(true)}>
          <AiFillEdit id="editIcon" /> Edit Listing
        </div>
        <div
          className="deleteIconAndText"
          onClick={() => setShowDeleteModal(true)}
        >
          <AiFillDelete id="deleteIcon" /> Delete Listing
        </div>
        {showDeleteModal && (
            ...
            <div className="deleteModalContentContainer">
              ...
              <div className="confirmOrCancelDeletButtons">
                <Button
                  label={"Delete"}
                  type={"button"}
                  className={"confirmDeleteSpotButton"}
                  onClick={handleDelete}
                />
                <Button
                  label={"Cancel"}
                  type={"button"}
                  className={"confirmCancelSpotButton"}
      ...
      {showEditModal && (
        <Modal idName="editModal" onClose={() => setShowEditModal(false)}>
          <div className="editModalMainContent">
            <div className="closeIconAndEditTextContainer">
              <div>
                <div
                  className="closeEditModalContainer"
