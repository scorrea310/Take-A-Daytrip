        ...
        <div onClick={() => {
            ...
            <div>
                {placesYouBeen && <div>
                    ...
                    <div className="account-card-description">See the trips you've been to.</div>
                </div>}
                {yourListings && <div>
                    <div className="account-card-title">Manage Listings</div>
                    <div className="account-card-description">View and Manage your listings.</div>
                </div>}
                {personalInfo && <div>
                    <div className="account-card-title">Account Info</div>
                    <div className="account-card-description">See and Edit your account details.</div>
                </div>}
            </div>
        </div>
    )
