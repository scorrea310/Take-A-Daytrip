    ...
    <div className="footerContainer">
      <div className="aboutLinksSectionFooter">
        ...
        <div className="aboutCategory">
          ...
          <a className="aboutText" href="https://github.com/scorrea310">
            GitHub{" "}
          </a>
        </div>
        <div className="aboutCategory">
        ...
        <div className="aboutCategory">
          ...
          <a
            className="aboutText"
            href="https://song-cloud-clone.herokuapp.com/"
          >
            SongCloud
          </a>
          <a className="aboutText" href="https://shop-qwerty.herokuapp.com/">
            Qwerty{" "}
          </a>
        </div>
      </div>
      ...
      <div className="bottomSectionFooter">
        <div className="bottomFooterText">
          © 2022 Take A Daytrip, Inc. · Privacy · Terms · Sitemap
        </div>
